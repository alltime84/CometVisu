...
(function() {
  ...
  function buildMenu( page, path ) {
    ...
    if (window.innerWidth <= templateEngine.maxMobileScreenWidth) {
      ...
      nav += '<img src=\'designs/material/images/icon/CometVisu-Icon_v4_webapp_icon_android_72.png\' width=\'36px\' height=\'36px\'/>';
      nav += '&nbsp; CometVisu &nbsp; ';
      nav += '<img src=\'designs/material/images/ic_chevron_left_black_24dp_2x.png\' width=\'24px\' height=\'24px\' style=\'float:right; margin-top:12px\'/>';
      nav += '</div>';
      nav += '</div>';
      nav += '</div>';
      nav += '<hr/>';
